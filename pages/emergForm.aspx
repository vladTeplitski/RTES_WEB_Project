    ...
    <div class="row row-centered " style="margin-bottom: 25px;" ng-controller="emergFormController">
        ...
        <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-xs-12 col-centered " style="background: rgba(78, 134, 183, 0.8); border-left: 5px solid #C9EC25; border-right: 5px solid #C9EC25; border-radius: 5px; margin-top: 5px; margin-bottom: 5px; padding-bottom: 5px;">
            ...
            <form style="color: #ffffff" name="myForm">
                ...
                <!--button + -->
                <br />
                <div style="background: rgba(217, 219, 241, 0.5); width: 30%; border-radius: 3px; border-bottom: 2px solid #D9DBF1; border-top: 2px solid #D9DBF1; padding: 1px;" class="driverDetailsButt" ng-show="driverDetailsBut">
                    Driver Details
                ...
                <div style="background: rgba(217, 219, 241, 0.5); width: 30%; border-radius: 3px; border-bottom: 2px solid #D9DBF1; border-top: 2px solid #D9DBF1; padding: 1px; mar" class="carDetailsButt" ng-show="carDetailsBut">
                    Car Details
                ...
                <br />
                <div style="background: rgba(217, 219, 241, 0.5); width: 38%; border-radius: 3px; border-bottom: 2px solid #D9DBF1; border-top: 2px solid #D9DBF1; padding: 1px;" class="insuranceDetailsButt" ng-show="insuranceDetailsBut">
